...
The maps on this branch are the extracted reference prototype. They have not been upgraded to MapLibre and are not the proposed final design. [Network intelligence mapping scope and acceptance criteria](../../specs/NetworkMaps.md). Chart-only work continues in [PR #4](https://github.com/lanej/easy-ui/pull/4); the measurements below retain the original combined-prototype source.
