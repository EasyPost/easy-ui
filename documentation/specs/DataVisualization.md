...
Mapping is a separate workstream and draft PR covering geographic navigation, parcel and network flow, facility risk, weather, and audience-specific views. The chart PR retains all six non-geographic logistics recipes and the existing eight-series modular preset.
