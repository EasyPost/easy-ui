// Extracted ECharts reference prototype. The MapLibre replacement and network
// intelligence requirements are specified in documentation/specs/NetworkMaps.md.
