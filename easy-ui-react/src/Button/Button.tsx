 ...
 * to move forward in a flow. Supports icons, multiple colors, outlined
 * and link variations, and small size buttons. Underlying element is a
 * button element, but becomes an achor when `href` is provided.
 *
 * @example
 * _Default:_
 * ```tsx
