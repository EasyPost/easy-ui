...
Independent production harness for the optional `NetworkMap` entry. It uses synthetic records and CARTO/OSM raster tiles; no customer data, private imagery or account credentials are required.
